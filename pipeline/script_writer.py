...

{
  ...
  "fb_comment": "The pinned FB FIRST COMMENT — write it like the CREATOR speaking warmly and personally to their audience (first person, human, PREMIUM — never a robotic CTA). 2 short sentences, <=32 words, channel's primary language: (1) a genuine reflective line about THIS video's specific subject/claim that shows you actually care about it, then (2) a specific question inviting the viewer to share THEIR take/experience + a soft 'I read & reply to every comment'. Add ONE fitting emoji. NO links, NO hashtags, NO clickbait. This is pinned first to spark replies (comment velocity = FB reach). Example (godmind, Kali): 'Kali's rage is the part of us we're all taught to hide. 🕉️ Do you feel it in you too? Tell me honestly below — I read every comment.' Example (ancient, Roman concrete): 'It still amazes me their concrete outlasts ours by 2000 years. 🌌 Accident, or lost tech we forgot? Drop your theory — I reply to everyone.'",
  "visuals": [
